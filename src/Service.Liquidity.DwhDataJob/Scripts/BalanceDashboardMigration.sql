...
insert into liquidity_dwhdata.balancedashboard ("Asset", "UpdateDate", "ClientBalance", "BrokerBalance", "Commission")
select
    ass.Symbol as Asset,
    (current_timestamp at time zone 'utc') as UpdateDate,
